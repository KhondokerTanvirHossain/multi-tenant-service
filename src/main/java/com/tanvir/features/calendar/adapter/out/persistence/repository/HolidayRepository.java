package com.tanvir.features.calendar.adapter.out.persistence.repository;

import com.tanvir.features.calendar.adapter.out.persistence.entity.HolidayEntity;
...
public interface HolidayRepository extends ReactiveCrudRepository<HolidayEntity, String> {
	...
	@Query("""
			...
			inner join loan_account la on
			la.member_id  = msopm.member_id
